...
def upgrade() -> None:
    ...
    op.create_index("idx_block_metrics_timestamp", "block_metrics", ["timestamp"], unique=False)
    op.create_index(
    ...
    op.create_index(op.f("ix_gas_metrics_timestamp"), "gas_metrics", ["timestamp"], unique=False)
    op.create_table(
        "mempool_metrics",
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column("timestamp", sa.DateTime(), nullable=False),
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_network_health_scores_timestamp"), table_name="network_health_scores")
